...
function Create() {
    ...
    const formAdd = useFormik({
        ...
        validationSchema: Yup.object().shape({
            name: Yup.string().required("phai nhap du lieu")
        }),
    ...
    const isFormikValid = (name) => !!(formAdd.touched[name] && formAdd.errors[name]);
    const getFormikMessage = (name) => {
        return isFormikValid(name) && <h5 className="p-error p-0 m-0">{formAdd.errors[name]}</h5>
    }
            ...
            <div className="container w-50" style={{ alignContent: "center" }}>
                <form className="row g-3" onSubmit={formAdd.handleSubmit}>
                    <div className="col-md">
                        ...
                        <input type="text" className="form-control" name="name" id="name" onChange={formAdd.handleChange} required />
                        {getFormikMessage("name")}
                    </div>
                    ...
                    <div class="input-group"><span class="input-group-text">Số phòng</span>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div className="    row g-2">
                                    ...
                                    <div className="col-md">
                                        <div className="form-floating"><select className="form-select" name="rooms[0].typeId" id="rooms.typeId" onChange={formAdd.handleChange}>
